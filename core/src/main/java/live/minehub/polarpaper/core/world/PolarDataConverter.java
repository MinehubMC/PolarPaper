...
public interface PolarDataConverter {
    ...
    default int defaultDataVersion() {
        return SharedConstants.getCurrentVersion().dataVersion().version(); // https://github.com/Minestom/Minestom/blob/master/src/autogenerated/java/net/minestom/server/MinecraftConstants.java
    }
