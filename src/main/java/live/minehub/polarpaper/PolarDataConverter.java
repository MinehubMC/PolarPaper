...
public interface PolarDataConverter {
    ...
    default int defaultDataVersion() {
        return Bukkit.getUnsafe().getDataVersion(); // https://github.com/Minestom/Minestom/blob/master/src/autogenerated/java/net/minestom/server/MinecraftConstants.java
    }
